...
const Navbar = () => {
  ...
  return (
    <div className="sticky w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 box-border">
        <div>
            <img src={MS3} alt="Logo Image" style={{ width: "50px" }} /> 
        </div>
